let process = {
	...
	page2:function(){
		let content = <div>
				...
				<div align='center'>
						<img src='img/Panzanella.jpg' height='200' width='300' /></div>

				<p >
				<h2><br/><div>INGREDIENTS</div></h2>
	...
	page1:function(){
		let content = <div>
				...
				<div align='center'>
						<img src='img/chicken parmesan.jpg' height='200' width='300' /></div>
...
page3:function(){
		let content = <div>
				...
				<div align='center'>
						<img src='img/Pesto-Stuffed Chicken Breast.jpg' height='200' width='300' /></div>
...
page4:function(){
		let content = <div>
				...
				<div align='center'>
						<img src="Bruschetta-Topped Pasta and Meatballs.jpg" height='200' width='300' /></div>
...
page5:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Italian Pasta and Beef Bake.jpg" height='250' width='350' /></div>
...
Bake at 350°F. for 15 minutes. Uncover; sprinkle with cheese. Bake uncovered an additional 5 to 10 minutes or until casserole is bubbly and cheese is melted.
	...
	page6:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Easy Beef Burrito Skillet.jpg" height='250' width='350' /></div>
	...
	page7:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Garlic Cheddar Chicken.jpg" height='250' width='350' /></div>
	...
	page8:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Olive, pepperoni and basil pizza.jpg" height='250' width='350' /></div>
	...
	page9:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/mushroom risotto.jpg" height='250' width='350' /></div>
...
page10:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Pasta Carbonara.jpg" height='250' width='350' /></div>
	...
	page11:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Hamburger Stroganoff Casserole.jpg" height='250' width='350' /></div>
	...
	page12:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Crispy roast pork shoulder (porchetta).jpg" height='250' width='350' /></div>
	...
	page13:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Cannoli.jpg" height='250' width='350' /></div>
	...
	page14:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Panna Cotta Raspberry Coulis.jpg" height='250' width='350' /></div>

				<p>
				<h2><br/><div>INGREDIENTS</div></h2>
					
					<div>4 sheets of gelatine</div>
					<div>2-3 Tbsp water</div>
					<div>250 ml milk</div>
	...
	page15:function(){
		let content = <div>
				...
				<div align="center">
						<img src="img/Pasta Con Pomodoro E Basilico.jpg" height='250' width='350' /></div>
